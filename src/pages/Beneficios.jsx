      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {[
            ...
            ["🛡️", "Reducción de Errores", "Menos bugs y fallos críticos que interrumpan el proceso de aprendizaje."],
            ["⏱️", "Ahorro de Tiempo", "Menos tiempo dedicado a correcciones y más para nuevas funcionalidades."],
